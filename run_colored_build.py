...
LABEL_POSITIONS = {
    'United States': (210, 210), 'Canada': (200, 140), 'Brazil': (340, 340),
    'Russia': (680, 120), 'China': (790, 220), 'India': (715, 270),
    'Australia': (860, 390), 'Greenland': (350, 60), 'Argentina': (315, 420),
    'Algeria': (490, 230), 'Kazakhstan': (680, 175), 'Mongolia': (770, 160),
    'Saudi Arabia': (600, 250), 'Egypt': (550, 220), 'Turkey': (585, 195),
    'United Kingdom': (465, 145), 'France': (485, 175), 'Spain': (450, 205),
    'Germany': (525, 160), 'Poland': (555, 155), 'Sweden': (525, 110),
    'Indonesia': (820, 305), 'Mexico': (180, 245), 'South Africa': (545, 410)
}
...
def get_color(pct_str):
    ...
    if pct >= 95:
        ...
        # Interpolate light blue -> deep ocean blue for 1-90%
        ratio = pct / 90.0
